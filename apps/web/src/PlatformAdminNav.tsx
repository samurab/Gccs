import { Building2, Inbox, LayoutDashboard, LogOut } from "lucide-react";
import type { PlatformAccess } from "./lib/api";

type PlatformAdminNavProps = {
  access: PlatformAccess;
  active: "overview" | "demo-requests" | "tenant-onboarding";
};
...
export function PlatformAdminNav({ access, active }: PlatformAdminNavProps) {
  const links = [
    ...
    { key: "tenant-onboarding", href: "/platform/tenants/new", label: "Tenant onboarding", icon: Building2, visible: access.canProvisionTenants }
  ] as const;
