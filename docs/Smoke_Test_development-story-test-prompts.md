...
Phase 0 Stories `0.1` through `0.8` and SOC 2 Stories `39.1` through `39.3` are non-software evidence workflows and are intentionally excluded from application smoke testing. Verify them with the governed human-evidence prompts in [development-story-test-prompts.md](development-story-test-prompts.md); do not report an app smoke test as proof of research quality, control operation, or an issued independent report.
...
Please perform Smoke test on Story 29.3: SSP Export And Review Package. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage.
...
Please perform Smoke test on Story 35.1: SAML Identity Provider Configuration. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
...
Please perform Smoke test on Story 35.2: SSO Sign-In Enforcement And Account Linking. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
...
Please perform Smoke test on Story 35.3: SCIM User And Group Provisioning. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
...
Please perform Smoke test on Story 36.1: Government Cloud Environment Configuration. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
...
Please perform Smoke test on Story 36.2: Regulated Tenant Provisioning Workflow. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
...
Please perform Smoke test on Story 36.3: Government Cloud Release And Operations Readiness. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
...
Please perform Smoke test on Story 37.1: FedRAMP Control Mapping Baseline. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
...
Please perform Smoke test on Story 37.2: Trust Artifact Library. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
...
Please perform Smoke test on Story 37.3: FedRAMP Readiness Export Package. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
...
Please perform Smoke test on Story 38.1: CUI Enclave Boundary Model. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
...
Please perform Smoke test on Story 38.2: Customer-Managed Key Policy And Rotation. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
...
Please perform Smoke test on Story 38.3: Enclave Access, Export, And Support Controls. Please provide the results of the tests.
Using the local GCCS app, execute the following test case as a verification script. Capture setup data, exact steps, expected result, actual result, and any defects or missing coverage. Keep enterprise identity, regulated deployment, FedRAMP readiness, CUI enclave, customer-managed key, tenant isolation, RBAC, audit logging, source traceability, review metadata, and data-handling controls in scope where relevant.
