# Terms And Disclaimer Language For Counsel Review

Document type: draft legal and sales disclaimer language.

Status: not approved for external use.
...
- Product description and claim boundaries.
- No-CUI data posture and prohibited data language.
- Customer responsibilities.
- Pilot scope and conversion terms.
- Limitation of advice and professional-services disclaimers.
- CMMC and compliance-report language.
...
## Draft Customer Responsibility Clause
...
## Draft Pilot Scope Clause

The guided pilot is limited to one agreed readiness workflow using synthetic, redacted, or non-sensitive data. Unless expressly agreed in writing, the pilot excludes real CUI handling, legal advice, accounting advice, labor determinations, CMMC certification, assessor determinations, custom integrations, GovCloud, FedRAMP, SSO, SCIM, and enterprise procurement support.

The pilot fee is non-refundable unless otherwise agreed in writing. If Customer converts to an annual subscription within the agreed conversion period, the pilot fee may be credited toward the first annual subscription according to the applicable order form.
...
- Replaces a CMMC assessor, attorney, CPA, labor expert, contracting officer, or qualified advisor.
- Has government approval, authorization, or endorsement unless formally true and reviewed.
- Accepts or processes real CUI in the MVP.

## Open Questions For Counsel

- What exact definition of "prohibited data" should appear in customer agreements?
- Should the pilot fee be refundable, non-refundable, or credit-only?
- What warranty disclaimer is appropriate for source-backed compliance content?
- What limitation of liability should apply to readiness reports and obligation records?
- What data-processing addendum is required for No-CUI customer metadata?
- What incident notification commitments are appropriate for suspected prohibited-data entry?
- What language is required for state privacy law, cybersecurity, and commercial SaaS contracting obligations?
