...
- Production smoke tests have not run because no actual production workflow run is attached. Pilot onboarding remains blocked until `docs/production-readiness-production-smoke-evidence.md` records a reviewed pass using synthetic or non-sensitive data only.
