...
- Production malware scanning is not enabled; `docs/production-readiness-malware-scanning-decision.md` records draft exception `PR43-MALWARE-001`, but production launch remains blocked until product and security owners approve the exception or scanner evidence is attached.
