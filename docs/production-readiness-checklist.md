...
| --- | --- | --- | --- | --- | --- |
| No-CUI posture | Customer-facing data handling notice is visible in onboarding, upload flows, docs, and support scripts. Real CUI upload remains prohibited until a future approved CUI-ready posture is implemented. | `README.md`, `docs/product-strategy.md`, `docs/mvp-execution-plan.md` | Product owner | Legal or contracting advisor | Ready for approval |
...
- The MVP must not store CUI until a future approved CUI-ready posture is implemented.
