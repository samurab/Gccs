...
| --- | --- | --- |
| Approved launch candidate artifact | Passed | Manifest `docs/release/approved-launch-candidate.json` approves tag `launch-candidate-2026-07-22-1` at `65e9133064dff1d4d529447afd35c67cc1a2ecba`; see `docs/production-readiness-launch-candidate-tag.md`. |
