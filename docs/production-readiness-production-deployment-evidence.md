...
Approved launch candidate tag: `launch-candidate-2026-07-28-2`.
...
| --- | --- | --- |
| Approved launch candidate artifact | Passed | Manifest `docs/release/approved-launch-candidate.json` approves tag `launch-candidate-2026-07-28-2` at `ce825a3287a75e2cebf043c0fb11167886d0babd`; see `docs/production-readiness-launch-candidate-tag.md`. |
