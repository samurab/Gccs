...
Approved launch candidate tag: `launch-candidate-2026-07-28-1`.
...
| --- | --- | --- |
| Approved launch candidate artifact | Passed | Manifest `docs/release/approved-launch-candidate.json` approves tag `launch-candidate-2026-07-28-1` at `fa41bcb184ebeb42da77cb0dfc513d3a647db5d4`; see `docs/production-readiness-launch-candidate-tag.md`. |
