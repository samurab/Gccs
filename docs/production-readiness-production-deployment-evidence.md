...
Approved launch candidate tag: `launch-candidate-2026-07-24-1`.
...
| --- | --- | --- |
| Approved launch candidate artifact | Passed | Manifest `docs/release/approved-launch-candidate.json` approves tag `launch-candidate-2026-07-24-1` at `44da818dc01a56acde07f6665739547e9717e5e8`; see `docs/production-readiness-launch-candidate-tag.md`. |
