# Automated Production Readiness Story Test Prompts

Use these prompts to create or update automated verification for each story in [production-readiness-story-test-cases.md](production-readiness-story-test-cases.md). Execute one story prompt at a time.

## Shared Automated Test Requirements

Use these requirements for every automated production readiness test prompt:

- Treat the MVP as **No-CUI / compliance management only with synthetic CUI-ready demonstration workflows**.
- Use synthetic or non-sensitive fixtures only. Do not use real customer CUI, production secrets, production logs, or customer-identifying data.
- Prefer automated verification for code-backed controls: server-side tenant mode enforcement, RBAC, tenant isolation, upload controls, report controls, audit logging, health checks, schema validation, and CI/CD scripts.
- For governance-only controls, create the narrowest practical automated document check, grep check, schema check, fixture validation, or launch-package completeness check.
- If a test cannot be automated, create a documented manual gate with objective pass/fail fields and mark the missing automation as a gap.
- Run the narrowest relevant test command and report results.
- Any failed, skipped, unavailable, or manual-only verification must include blocker/risk disposition with owner, mitigation, and target date.

Recommended automated-test instruction:

```text
Using the existing GCCS architecture, test projects, and documentation validation patterns, create or update automated tests for the following production readiness test cases. Use synthetic or non-sensitive data only. Keep No-CUI posture, tenant isolation, server-side RBAC, audit logging, tenant mode enforcement, upload controls, report claim controls, source traceability, and review metadata in scope. For governance-only checks, add automated document/schema/grep validation where practical. Run the narrowest relevant test command and report results.
```
...
Please perform automated test coverage for Story PR-0.1: Record And Approve Launch Posture. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-0.2: Align Launch Documents To No-CUI Posture. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-0.3: Verify Tenant Mode Boundary Design. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-1.1: Re-Run Definition Of Ready For Open MVP Stories. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-1.2: Map Open Stories To Test Cases. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-1.3: Gate Risky Workflow Changes. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-2.1: Freeze MVP Launch Scope. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-2.2: Re-Run Definition Of Done For Completed MVP Stories. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-2.3: Convert Completion Gaps Into Launch Decisions. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-3.1: Deploy And Smoke Test Staging. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-3.2: Execute End-To-End MVP Workflow In Staging. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-3.3: Verify Tenant Isolation And RBAC In Staging. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-3.4: Verify Upload Guardrails And Report Controls In Staging. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-4.1: Attach Backup And Restore Evidence. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-4.2: Attach Deployment, Migration, And Rollback Evidence. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-4.3: Decide Malware Scanning Launch Path. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-5.1: Review High-Risk Obligation Content. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-5.2: Review Customer-Facing Claims. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-5.3: Finalize Support Runbooks. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-5.4: Prepare Pilot Onboarding, Release Notes, And Known-Risk Log. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-6.1: Collect Required Launch Approvals. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-6.2: Tag Launch Candidate With Evidence Links. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-7.1: Deploy Production Through Approved CI/CD. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-7.2: Run Production Smoke Tests. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-7.3: Onboard Controlled Pilot Customers. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-8.1: Monitor Pilot Signals Daily. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-8.2: Hold Post-Launch Readiness Review. Please provide the results of the tests.
...
Please perform automated test coverage for Story PR-8.3: Gate Phase 2 Until MVP Controls Are Stable. Please provide the results of the tests.
