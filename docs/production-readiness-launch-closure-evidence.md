...
| Launch candidate tag | PR-6.2 | Approved launch candidate manifest `docs/release/approved-launch-candidate.json` records tag `launch-candidate-2026-09-13-1` at commit `dcd2d44cf2252f81a67158e2cce5e47c015cd145` and links build, deployment, smoke, release, rollback, support, content, approval, and known-risk evidence. | `docs/release/approved-launch-candidate.json`, `docs/production-readiness-launch-candidate-tag.md` | No |
