...
| Launch candidate tag | PR-6.2 | Approved launch candidate manifest `docs/release/approved-launch-candidate.json` records tag `launch-candidate-2026-07-24-1` at commit `44da818dc01a56acde07f6665739547e9717e5e8` and links build, deployment, smoke, release, rollback, support, content, approval, and known-risk evidence. | `docs/release/approved-launch-candidate.json`, `docs/production-readiness-launch-candidate-tag.md` | No |
