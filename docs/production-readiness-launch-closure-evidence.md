...
| Launch candidate tag | PR-6.2 | Approved launch candidate manifest `docs/release/approved-launch-candidate.json` records tag `launch-candidate-2026-07-26-1` at commit `ffc76b28fcd82d0fe480bbb3ab5c8f37b7be9518` and links build, deployment, smoke, release, rollback, support, content, approval, and known-risk evidence. | `docs/release/approved-launch-candidate.json`, `docs/production-readiness-launch-candidate-tag.md` | No |
