...
| Production deployment | PR-7.1 | Candidate `launch-candidate-2026-08-16-1` at `d0fa9503c0487aacd54443f971c04982501fe408` passed protected production workflow run `31968286655`, including tag/SHA validation, No-CUI guardrails, build, migration application, API/web deployment, dependency health, and evidence upload. | `docs/production-readiness-production-deployment-evidence.md`, `.github/workflows/production.yml`, `infra/terraform/environments/production/main.tf`, workflow artifact `9269133023` | No for the solo-controlled No-CUI pilot deployment; broader launch and CUI processing remain blocked |
