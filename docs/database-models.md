...
| SSP builder | `ssp_sections`, `ssp_section_links`, `ssp_section_source_references`, `ssp_section_status_history` | Tenant-scoped structured SSP sections, verified source-record links, review metadata, optimistic versions, and append-only lifecycle history. |
