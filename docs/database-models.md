...
| People and labor | `employees`, `training_records`, `wage_determinations`, `labor_applicabilities`, `labor_category_rates`, `labor_classifications`, `payroll_records` | Training, tenant-scoped source-backed SCA/DBA/FAR Part 22 applicability decisions, contract/clause/task/evidence links, review metadata, wage records, labor category mapping, and payroll evidence references. |
