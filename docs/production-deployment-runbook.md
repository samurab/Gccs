...
| Approved launch candidate tag | `launch-candidate-2026-08-23-1` |
| Launch candidate commit | `8bcd6300ab854af28e8988639e4c24046c311b22` |
...
gh workflow run ".github/workflows/production.yml" \
  --repo samurab/Gccs \
  --ref main \
  -f launch_candidate_tag=launch-candidate-2026-08-23-1
```
