...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260618215924_AddCuiReadyApprovalChecklists') THEN
    CREATE TABLE gccs.cui_ready_approval_checklists (
        id uuid NOT NULL,
        tenant_id uuid NOT NULL,
        ...
        updated_at timestamp with time zone,
        updated_by_user_id uuid,
        CONSTRAINT "PK_cui_ready_approval_checklists" PRIMARY KEY (id),
        CONSTRAINT "FK_cui_ready_approval_checklists_tenants_tenant_id" FOREIGN KEY (tenant_id) REFERENCES gccs.tenants (id) ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260618215924_AddCuiReadyApprovalChecklists') THEN
    CREATE TABLE gccs.cui_ready_approval_checklist_items (
        id uuid NOT NULL,
        checklist_id uuid NOT NULL,
        item_key character varying(120) NOT NULL,
        section character varying(180) NOT NULL,
        ...
        CONSTRAINT "PK_cui_ready_approval_checklist_items" PRIMARY KEY (id),
        CONSTRAINT "FK_cui_ready_approval_checklist_items_cui_ready_approval_check~" FOREIGN KEY (checklist_id) REFERENCES gccs.cui_ready_approval_checklists (id) ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260618215924_AddCuiReadyApprovalChecklists') THEN
    CREATE UNIQUE INDEX "IX_cui_ready_approval_checklist_items_checklist_id_item_key" ON gccs.cui_ready_approval_checklist_items (checklist_id, item_key);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260618215924_AddCuiReadyApprovalChecklists') THEN
    CREATE INDEX "IX_cui_ready_approval_checklists_created_at_updated_at" ON gccs.cui_ready_approval_checklists (created_at, updated_at);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260618215924_AddCuiReadyApprovalChecklists') THEN
    CREATE INDEX "IX_cui_ready_approval_checklists_tenant_id_state_created_at" ON gccs.cui_ready_approval_checklists (tenant_id, state, created_at);
    END IF;
END $EF$;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260618220401_AddCuiReadyApprovalGateMetadata') THEN
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260618221738_AddSharedResponsibilityMatrixAcknowledgements') THEN
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260618222615_AddDataHandlingNoticeAcknowledgements') THEN
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260618223016_AddCuiSupportEscalations') THEN
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260618223412_AddCuiSupportEscalationWorkflow') THEN
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260625224919_AddPendingReleaseReadinessModelChanges') THEN
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260626151206_AddAuditLogOldNewValues') THEN
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM gccs."__EFMigrationsHistory" WHERE "MigrationId" = '20260626194212_AddReusableComplianceChecklists') THEN
